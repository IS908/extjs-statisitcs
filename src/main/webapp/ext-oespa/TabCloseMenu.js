...
Ext.define('Ext.ux.TabCloseMenu', {
    ...
    onHideMenu: function () {
        var me = this;
        me.item = null;
        me.fireEvent('', me.menu, me);
    },

    onClose : function(){
    	var me = this;
    	var rs = me.fireEvent('beforeclose', me.item, me);
        if(rs){
    ...
    onCloseOthers : function(){
    	var me = this;
    	var rs = me.fireEvent('beforecloseOthers', me.tabPanel.items.items,  me.item, me);
        if(rs){
        	this.doClose(true);
        }
    ...
    onCloseAll : function(){
    	var me = this;
    	var rs = me.fireEvent('beforecloseAll', me.tabPanel.items.items, me);
        if(rs){
        	this.doClose(false);
        }
    },
